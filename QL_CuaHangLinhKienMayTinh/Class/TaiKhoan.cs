...
namespace QL_CuaHangLinhKienMayTinh.Class
{
    internal class TaiKhoan
    {
        ...
        public DataTable SearchMaNV_TaiKhoan(int manv)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("\tSELECT NHANVIEN.MaNV,Username,NHANVIEN.ChucVu FROM TAIKHOAN,NHANVIEN WHERE NHANVIEN.MaNV=TAIKHOAN.MaNV and NHANVIEN.MaNV=@MaNV", con);
                cmd.Parameters.AddWithValue("@MaNV", manv);
